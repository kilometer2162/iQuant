...
from trader.utility import get_file_logger
...
class WebsocketClient:
	...
	* on_error
	...
	def init(self, host: str, ping_interval: int = 60, proxy_host: str = "", proxy_port: int = 0, header: dict = None, log_path: Optional[str] = None):
		"""
		:param host:
		:param header:
