...
class RestClient(object):
	...
	* Reimplement on_error function to handle exception msg.
	...
	def init(self, url_base: str) -> None:
		"""
	...
	def on_failed(self, status_code: int, request: Request) -> None:
		...
		"""
		sys.stderr.write(f'{str(status_code)} {str(request)}')

	def on_error(self, exception_type: type, exception_value: Exception, tb, request: Optional[Request]) -> None:
		"""
	...
	def exception_detail(self, exception_type: type, exception_value: Exception, tb, request: Optional[Request]) -> str:
	...
	def make_full_url(self, path: str) -> str:
		"""
		Make relative net path into full url.
		eg: make_full_url("/get") == "http://xxxxx/get"
		"""
		url = self.url_base + path
		return url

	def request(self, method: str, path: str, params: dict = None, data: dict = None, headers: dict = None) -> requests.Response:
		"""
		Add a new request.
		:param method: GET, POST, PUT, DELETE, QUERY
		:param path: url path for query
